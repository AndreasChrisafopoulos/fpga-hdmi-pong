module LEDdecoder(
    input [3:0] char,     // 4-bit char (0-F)
    output CA, CB, CC, CD, CE, CF, CG // segments
);
...
always @(char) begin
    case(char)
        ...
        4'hB: {CA_r, CB_r, CC_r, CD_r, CE_r, CF_r, CG_r} = 7'b1100000;// display b
        4'hC: {CA_r, CB_r, CC_r, CD_r, CE_r, CF_r, CG_r} = 7'b0110001;
        4'hD: {CA_r, CB_r, CC_r, CD_r, CE_r, CF_r, CG_r} = 7'b1000010;// display d
